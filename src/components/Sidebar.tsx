...
const navigation = [
  {
    ...
    items: [
      ...
      { name: "바이브 코딩 기초", href: "/docs/vibe-coding" },
      { name: "  ∟ 왜 바이브 코딩인가?", href: "/docs/vibe-coding/why-vibe-coding" },
      { name: "  ∟ CLAUDE.md란?", href: "/docs/vibe-coding/claude-md" },
      { name: "  ∟ 실습: /init", href: "/docs/vibe-coding/init-practice" },
      { name: "  ∟ MCP란?", href: "/docs/vibe-coding/what-is-mcp" },
      { name: "  ∟ 실습: MCP 설치", href: "/docs/vibe-coding/mcp-install" },
      { name: "  ∟ 필수 기능", href: "/docs/vibe-coding/essential-features" },
      { name: "  ∟ 정리", href: "/docs/vibe-coding/summary" },
